<?php
	...
	$algorithm = $_REQUEST['algorithm'];
    	...
    	shell_exec(" openssl dgst '".$algorithm."' -hmac '".$key."' '".$fileIn."' > '".$fileOut."' ");
    }
    ...
    <body onload="switchSide()">
        <form method="post">
    		...
    		<div class="options-area">
                    ...
                    <div class="key-hmac">
    			        <a class="key">Key</a>
    			        <input type="text" class="input-text" name="key" placeholder="Insert the key in hexadecimal" required><br>
    				</div>

    				<div class="file-out-hmac">
    					<a class="ficheiro-saida">File Out</a>
    					<input type="text" name="fileOut" placeholder="Insert the file out name" required><br>
    				</div>

                    <div class="button-content">
                        <button name="generate-hmac" class="generate-button-2">Calculate HMAC</button>
                    </div>
